...
# ===========================================================================================================================
    ...
    if selected_status_7 == 7:
        X_test, y_test = X[train_size+59:], y[train_size+59:]
    elif selected_status_7 == 14:
        X_test, y_test = X[train_size+52:], y[train_size+52:]
    elif selected_status_7 == 21:
        X_test, y_test = X[train_size+45:], y[train_size+45:]
    elif selected_status_7 == 28:
        X_test, y_test = X[train_size+38:], y[train_size+38:]
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.ylabel('Tital_kwh') 
        st.pyplot(fig5)
    plot_multi_step(np.array(y_test)*MAX, np.array(preds)*MAX)
    ...
    def evaluate_prediction(predictions, actual, model_name):
        ...
        if selected_status_8_3:
            st.write('MAE: {:.4f}'.format(mae))
        st.write('')
    evaluate_prediction(np.array(y_test)*MAX, np.array(preds)*MAX,'CNN-LSTM')
...
#=================================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.ylabel('Tital_kwh') 
        st.pyplot(fig6)
    plot_multi_step(df['Total_kWh'][-train_window:], actual_predictions)
